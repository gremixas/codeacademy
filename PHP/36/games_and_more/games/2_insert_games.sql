...
VALUES (
        ...
        "The Witcher 3: Wild Hunt is an action role-playing video game developed by Polish developer CD Projekt Red"
    ), (
        "Vampire: The Masquerade \u2013 Bloodlines",
        "2004-11-16",
        "Troika Games",
        "Action role-playing",
        "https://upload.wikimedia.org/wikipedia/en/9/96/Vampire_-_The_Masquerade_%E2%80%93_Bloodlines_Coverart.png",
        "PC,MAC,XONE,PS4,NS,PS5,XBSX",
        "Vampire: The Masquerade \u2013 Bloodlines is a 2004 action role-playing video \r\n            game developed by Troika Games and published by Activision for Microsoft Windows. \r\n            Set in White Wolf Publishing's World of Darkness, the game is based on White \r\n            Wolf's role-playing game Vampire: The Masquerade and follows a human who is killed\r\n             and revived as a fledgling vampire. The game depicts the fledgling's journey through \r\n             the early 21st-century Los Angeles to uncover the truth behind a recently discovered relic \r\n             that heralds the end of all vampires.",
        "A  action role-playing video game developed by Troika Games."
    ), (
        "Elden Ring",
        "2022-02-25",
        "FromSoftware",
        ...
        "PC,MAC,XONE,PS4,NS,PS5,XBSX",
        "Doom is a 2016 first-person shooter game developed by id Software and published by Bethesda Softworks. It is the first major installment in the Doom series since 2004's Doom 3. Players take the role of (pace marine, known as the \"Doom Slayer\", as he battles demonic forces from Hell that have been unleashed by the Union Aerospace Corporation within their energy-mining facility on Mars. ",
        "Doom is a 2016 first-person shooter game developed by id Software and published by Bethesda Softworks."
    ), (
        ...
        "Need for Speed Heat is a 2019 racing video game developed by Ghost Games and published by Electronic Arts."
    );